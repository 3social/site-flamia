    ...
    <div ref={containerRef} style={{ width: '100%', height: '100%', background: '#000' }}>
      <nav style={{
        ...
        <div style={{
          ...
          <a href="#servicios" style={{ color: 'white', textDecoration: 'none', opacity: 0.7, transition: 'opacity 0.3s' }} onMouseEnter={(e) => { e.currentTarget.style.opacity = '1'; }} onMouseLeave={(e) => { e.currentTarget.style.opacity = '0.7'; }}>
            Servicios
          </a>
          <a href="#tecnologia" style={{ color: 'white', textDecoration: 'none', opacity: 0.7, transition: 'opacity 0.3s' }} onMouseEnter={(e) => { e.currentTarget.style.opacity = '1'; }} onMouseLeave={(e) => { e.currentTarget.style.opacity = '0.7'; }}>
            Tecnología
          </a>
          <a href="#clientes" style={{ color: 'white', textDecoration: 'none', opacity: 0.7, transition: 'opacity 0.3s' }} onMouseEnter={(e) => { e.currentTarget.style.opacity = '1'; }} onMouseLeave={(e) => { e.currentTarget.style.opacity = '0.7'; }}>
            Clientes
          </a>
        </div>
      ...
      <div ref={(el) => {
        if (el) {
          const headline = el.querySelector('[data-animate="headline"]');
          if (headline) {
            gsap.to(headline, {
              y: -20,
              duration: 2,
